...
* **ui:** add clickable summary cards and improve diff display ([f5b7ca0](https://github.com/andrii-solokh/DuplicateManager/commit/f5b7ca0bda57f7427e31621f4f6a9d765caf5022))
* **ui:** enhance duplicate viewer UX with search improvements and dynamic styling ([4ba47b7](https://github.com/andrii-solokh/DuplicateManager/commit/4ba47b76ee960c12558df00f96484d15f03e6047))
* **ui:** make all summary cards clickable and improve section header ([4788176](https://github.com/andrii-solokh/DuplicateManager/commit/4788176522c4aae9bc55e37830b10db4909833a8))
...
* **ci:** add package.json to release-please extra-files ([2f041f1](https://github.com/andrii-solokh/DuplicateManager/commit/2f041f1d478107d6fbb48ab39a434da42e175b5f))

## [1.2.1](https://github.com/andrii-solokh/DuplicateManager/compare/DuplicateManager-v1.2.0...DuplicateManager-v1.2.1) (2026-01-18)


### Bug Fixes

* **ci:** add package promotion to CI workflow when release is created ([e8bb681](https://github.com/andrii-solokh/DuplicateManager/commit/e8bb68197206d64b1afc1f5da2e6cea33d4981fd))
* **ci:** sync sfdx-project.json version and configure release-please to update it ([4661591](https://github.com/andrii-solokh/DuplicateManager/commit/4661591b79caaaa30e54550f00e42a73cb215f11))
