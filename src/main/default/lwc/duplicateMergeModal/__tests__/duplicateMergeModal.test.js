    ...
    fields: [
        {
            ...
            values: [
                ...
                { recordId: '003000000000002', value: 'John', displayValue: 'John', isEmpty: false }
            ]
        },
        {
            apiName: 'LastName',
            ...
            allEmpty: false,
            values: [
                { recordId: '003000000000001', value: 'Doe', displayValue: 'Doe', isEmpty: false },
                { recordId: '003000000000002', value: 'D.', displayValue: 'D.', isEmpty: false }
            ]
        },
        {
            apiName: 'Email',
        ...
        },
        {
            ...
            allEmpty: true,
            values: [
                { recordId: '003000000000001', value: null, displayValue: '', isEmpty: true },
                { recordId: '003000000000002', value: null, displayValue: '', isEmpty: true }
            ]
        }
    ]
};
...
describe('c-duplicate-merge-modal', () => {
    ...
    it('sets first record as master by default', async () => {
        ...
        const selectedCard = element.shadowRoot.querySelector('.master-card.selected');
    ...
    it('filters to show only differences by default', async () => {
        ...
        const differenceRows = element.shadowRoot.querySelectorAll('.field-row.difference');
    ...
    it('filters fields by search term', async () => {
        ...
        if (searchInput) {
            ...
            const fieldRows = element.shadowRoot.querySelectorAll('.field-row');
            expect(fieldRows.length).toBeLessThanOrEqual(1);
        }
    });
    ...
    it('allows selecting values from non-master records', async () => {
        ...
        const selectableCells = element.shadowRoot.querySelectorAll('.value-cell.selectable');
    ...
    it('shows success state after successful merge', async () => {
        ...
        if (mergeButton) {
            ...
            const successState = element.shadowRoot.querySelector('.success-state');
