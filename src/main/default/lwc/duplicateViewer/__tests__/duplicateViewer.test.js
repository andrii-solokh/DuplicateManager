...
describe('c-duplicate-viewer', () => {
    ...
    it('renders duplicate sets after data loads', async () => {
        ...
        const cards = element.shadowRoot.querySelectorAll('.duplicate-card');
    ...
    it('filters duplicate sets by object type', async () => {
        ...
        combobox.dispatchEvent(new CustomEvent('change', { detail: { value: 'Contact' } }));
    ...
    it('opens detail modal when duplicate set is clicked', async () => {
        ...
        const card = element.shadowRoot.querySelector('.duplicate-card');
        if (card) {
            card.click();
